  ...
  return (
    <section className="relative h-screen flex items-center justify-center intro-background overflow-hidden">
      <div className="absolute z-10 top-10">
        <h1
          className={`intro-title text-[5rem] text-center ${
        ...
        <h1
          className={`intro-title text-center text-[5rem] intro-title-en ${
      ...
      <div className="relative z-10 flex items-start justify-center">
        {animation && (
          <Image
            ...
            width={250}
            height={250}
            className={`absolute z-20 top-3 left-[47%] transform -translate-x-1/2 ${
